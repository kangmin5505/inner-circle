...
then
  ...
  c++ $fast_flag run_stack.cpp && ./a.out
  c++ $fast_flag run_map.cpp && ./a.out
  c++ libbass.dylib -Ibass24 -Lbass24 check_results.cpp && ./a.out
